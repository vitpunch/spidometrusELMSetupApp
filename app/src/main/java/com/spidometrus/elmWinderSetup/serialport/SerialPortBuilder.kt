...
import com.spidometrus.elmWinderSetup.serialport.connect.BleCanWorkCallback
import com.spidometrus.elmWinderSetup.serialport.connect.ConnectionResultCallback
import com.spidometrus.elmWinderSetup.serialport.connect.ConnectionStatusCallback
...
object SerialPortBuilder {
    ...
    /**
     * 连接状态带类型回调接口函数 Статус соединения с функцией интерфейса обратного вызова типа
     * @param connectionStatusCallback 连接状态带类型回调接口 Статус соединения с интерфейсом обратного вызова типа
     * @Author Shanya
     * @Date 2021-8-13
     * @Version 4.0.3
     */
